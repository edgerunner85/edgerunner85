...
- Defensive proxy middleware implementation, vulnerability scanning suites (Garak, Tenable Nessus, Kali Linux architectures), automated guardrail assessments.
- Linux shell orchestration (Bash pipeline design), data processing engineering (Python tracking and Pandas telemetry extraction).
